...
import br.com.mystorage.bean.Bean;
import br.com.mystorage.db.ConexaoPostgreeSQL;
...
public abstract class ReadOnlyDAO<B extends Bean<T>, T extends Serializable> {
    ...
    protected final ConexaoPostgreeSQL db;
    ...
    public ReadOnlyDAO(Class<B> clazz) {
        this.db = ConexaoPostgreeSQL.getInstance();
     ...
     */
    protected ConexaoPostgreeSQL getDatabaseManager() {
        return db;
    }
